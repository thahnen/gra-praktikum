...
class ICameraDevicePtr(_object):
    ...
    def getCameraInfo(self, camInfo):
        return _roypy.ICameraDevicePtr_getCameraInfo(self, camInfo)
    ...
    def getNumberOfStreams(self, name, nrStreams):
        return _roypy.ICameraDevicePtr_getNumberOfStreams(self, name, nrStreams)
...
class ICameraDevice(_object):
    ...
    def getCameraInfo(self, camInfo):
        return _roypy.ICameraDevice_getCameraInfo(self, camInfo)
    ...
    def getNumberOfStreams(self, name, nrStreams):
        return _roypy.ICameraDevice_getNumberOfStreams(self, name, nrStreams)
